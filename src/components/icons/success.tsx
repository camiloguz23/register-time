...
export const Success = ({ className, size }: PropsIcons): JSX.Element => (
  <svg xmlns='http://www.w3.org/2000/svg' width={size ?? '24px'} height={size ?? '24px'} className={className} viewBox='0 0 48 48'>
    <defs>
      <mask id='ipSSuccess0'>
